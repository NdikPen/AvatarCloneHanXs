...
function _G.openSettingsApp()
    pcall(function()
        ...
        devName.Text = Config.DEVELOPER_USERNAME or "NdikPen"
        ...
        label(infoCard, "HanXsPhone  v1.0.0", 11, C.text, Enum.Font.GothamBold, 0)
        label(infoCard, "© 2026 " .. (Config.DEVELOPER_USERNAME or "NdikPen"), 9, C.text3, Enum.Font.Gotham, 1)
        label(infoCard, "Build: Hanxs | WUTWUT AREA", 8, C.text3, Enum.Font.Gotham, 2)
